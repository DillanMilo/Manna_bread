...
const SANDWICH_PLATTERS: CateringCategory = {
  ...
  sizes: [
    { name: 'Mini', detail: '12 quarter-size sandwiches', price: '$35' },
    { name: 'Medium', detail: '12 half-size sandwiches', price: '$55' },
    { name: 'Full Size', detail: '12 full-size sandwiches', price: '$85' },
  ],
  items: [],
  subsections: [
    {
