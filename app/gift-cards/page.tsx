...
export default function GiftCardsPage() {
  return (
    <main className="pt-24 sm:pt-32 md:pt-40 pb-14 sm:pb-20 md:pb-28 bg-brand-warm-white min-h-screen">
      <div className="max-w-4xl mx-auto px-5 sm:px-6 md:px-10 text-center">
        ...
        <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-medium text-brand-walnut leading-tight mb-6 sm:mb-8">
          Give the gift of Manna
        </h1>

        <div className="bg-brand-soft-cream rounded-2xl p-8 sm:p-10 md:p-12 mb-6 sm:mb-8">
